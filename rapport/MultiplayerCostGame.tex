...
\begin{defi}[Fonction de poids]
	...
	A chaque arc d'un graphe $G = (V,E)$ on peut y associer un \textit{poids} (i.e. une valeur chiffrée). On associe donc à $G$ une \textit{fonction de poids}  $w : E \rightarrow \mathbb{R}$. On dit alors que $G$ est un graphe \textit{pondéré}.
\end{defi}
