...
Cette section sera essentiellement inspirée des articles de Brihaye et al.~\cite{DBLP:conf/lfcs/BrihayePS13}~\ref{DBLP:conf/csr/BrihayeBP10}  .
...
\begin{defi}[Stratégie à mémoire finie]
	...
	Une stratégie $\sigma _{i} \in \Sigma _{i}$ est une \textit{stratégie à mémoire} si on peut lui associer un \textit{automate de Mealy} $\mathcal{A} = (M, m_{0}, V, \delta, \nu)$ où:
	\begin{enumerate}
